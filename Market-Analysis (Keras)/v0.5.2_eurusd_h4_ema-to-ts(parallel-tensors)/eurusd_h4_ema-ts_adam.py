...
from keras.layers import Input, Dense, GRU, Reshape, normalization
...
# ema 13+26, ema 78+156
#data_x_1, data_x_2 = data_x[:,0:2], data_x[:,2:4]

print( "data_x:", data_x.shape )
#print( "1:", data_x_1.shape, "2:", data_x_2.shape )
...
if( len(json_string) > 0 ):
    ...
    x = normalization.BatchNormalization( batch_input_shape=(None, 1, 4) )(inputs)
#    inputs = Input( shape=( 4, ) )
#    x = Reshape( ( 1, 4 ) )(inputs)
#    x = normalization.BatchNormalization( batch_input_shape=(None, 1, 4) )(x)
    x = GRU( gru1, input_shape=(1, 4) )(x) #, input_shape=(data_x.shape[1], data_x.shape[2])
...
# loss='mse', loss='msle'
# optimizer='adam', optimizer='rmsprop', optimizer='sgd'
