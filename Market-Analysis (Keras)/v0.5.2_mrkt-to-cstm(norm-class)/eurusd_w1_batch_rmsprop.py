...
prefix = 'eurusd_h4_ema-ts_batch_rmsprop'
...
if( len(json_string) > 0 ):
    ...
    model = Sequential()
    model.add( normalization.BatchNormalization( batch_input_shape=(None, data_x.shape[1], 1) ) )
    model.add( GRU( gru1, input_shape=(data_x.shape[1], 1) ) )#, dropout=0.2, recurrent_dropout=0.2
