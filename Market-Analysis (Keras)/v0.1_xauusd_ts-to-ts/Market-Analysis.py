...
#=============================================================================#
print('Prepare Data')
data_x = np.genfromtxt('XAUUSD.pro1440_x.csv', delimiter=',')
...
if( len(json_string) > 0 ):
    ...
    model = Sequential()
    model.add( GRU( 12, batch_input_shape=(None, 4, 1) ) )
...
#print('Predicting')
#
#data_z = np.genfromtxt('input_data_z.csv', delimiter=',')
#data_z = np.reshape( data_z, (data_z.shape[0], data_z.shape[1], 1) )
#
#print( "data_z:", data_z.shape )
#
#predicted_output = model.predict(data_z, batch_size=1)
#
#predicted_output
#
