...
--	wal_dir = "/var/log/tarantool";
	...
	sophia_dir = "sophia";
--	listen = 3313;
	custom_proc_title = 'masdb-httpd';
	pid_file = "masdb-httpd.pid";
	-------------------------
...
-- Start http server
httpd = require('http.server').new("127.0.0.1", 3333, handler="/usr/share/tarantool/masdb_http.lua", charset="application/json")
httpd:route()
httpd:start()
